...
<img src="image/bimscan.jpg" alt="Paris" width="100%" height="600">
<div class="centered">
    <h1>Scan To BIM </h1>
</div>
</div>
...
<div class="counter">
      ...
      <div class="counter">
        <i class=""></i>
        <span class="num" data-val="10"></span>
        <span class="text">Year of Experiance</span>
      </div>
      <div class="counter">
        <i class=""></i>
        <span class="num" data-val="5"><h1></h1></span>
...
Information translation can be done up to LOD 350-400 accurately based on information provided for all elements o Architectural buildings, facades, Interiors, and MEPF (Mechanical, Electrical, Plumbing, Fire Protection)data.<br><br>
</p>
</div>
